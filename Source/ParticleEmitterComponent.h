...
struct ParticleEmitterSettings
{
	ParticleEmitterSettings() :
		...
		MinEnergy(1.0f),
		MaxEnergy(2.0f),
		MinVelocity(DirectX::XMFLOAT3(0, 0, 0)),
...
public:
	...
	void SetMinVelocity(DirectX::XMFLOAT3 velocity) { m_Settings.MinVelocity = velocity; }
	void SetMaxVelocity(DirectX::XMFLOAT3 velocity) { m_Settings.MaxVelocity = velocity; }
...
private:
	...
	// Enable / disable the effect from spawning particles
	bool m_IsActive;
